...
module mlp_top #(
    ...
    parameter FC1_MEMORY_FILE = "fc1_weights.mem",

    parameter int FC2_TEMP = -2,
    ...
    parameter FC2_MEMORY_FILE = "fc2_weights.mem",

    parameter int FC3_TEMP = -2,
    ...
    parameter FC3_MEMORY_FILE = "fc3_weights.mem"
) (
